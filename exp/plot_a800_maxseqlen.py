#!/usr/bin/env python3
"""Plot maximum supported sequence length on 8x A800."""
...
FIG_PATH = os.path.join(SCRIPT_DIR, 'a800_maxseqlen.pdf')
...
def main():
    ...
    for i, fw in enumerate(frameworks):
        ...
        for j, v in enumerate(vals):
            if v is None:
                tag = rows[FRAMEWORK_ROWS_A800[i][0]][9 + j].strip()
    ...
    ax.set_title('Max Sequence Length on 8×A800 SXM', fontsize=13)
